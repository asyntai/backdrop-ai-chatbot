...
This module embeds the Asyntai chatbot on your Backdrop site and provides a simple admin interface to connect your site to Asyntai.


## Why choose Asyntai?

• **Increase conversions**: Instant, human like replies keep visitors engaged and informed.
...
1. Download and extract the module to `/modules/asyntai/`
2. Enable the module in Backdrop Admin Panel → Functionality
3. Find Asyntai → Enable
...
1. Go to Configuration → Web services → Asyntai AI Chatbot
